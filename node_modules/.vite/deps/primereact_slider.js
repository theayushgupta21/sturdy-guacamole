...
import { A as classNames, D as ObjectUtils, c as useMergeProps, n as useHandleStyle, o as useEventListener, t as ComponentBase, w as DomHandler, x as PrimeReactContext } from "./componentbase.esm-BaFTkeT7.js";

//#region node_modules/primereact/slider/slider.esm.js
...
var Slider = /* @__PURE__ */ import_react.memo(/* @__PURE__ */ import_react.forwardRef(function(inProps, ref) {
	...
	var handleIndex = import_react.useRef(0);
	var sliderHandleClick = import_react.useRef(false);
	var dragging = import_react.useRef(false);
	var initX = import_react.useRef(0);
	var initY = import_react.useRef(0);
	var barWidth = import_react.useRef(0);
	var barHeight = import_react.useRef(0);
	var touchId = import_react.useRef();
	...
	var _SliderBase$setMetaDa = SliderBase.setMetaData({ props }), ptm = _SliderBase$setMetaDa.ptm, cx = _SliderBase$setMetaDa.cx, sx = _SliderBase$setMetaDa.sx, isUnstyled = _SliderBase$setMetaDa.isUnstyled;
	useHandleStyle(SliderBase.css.styles, isUnstyled, { name: "slider" });
	var spin = function spin(event, dir) {
		updateValue(event, (props.range ? value[handleIndex.current] : value) + (props.step || 1) * dir);
	...
	var onDragStart = function onDragStart(event, index) {
		...
		if (props.range && value[0] === props.max) handleIndex.current = 0;
		else handleIndex.current = index;
		event.preventDefault();
	};
	...
	var _onTouchStart = function onTouchStart(event, index) {
		if (event.changedTouches && event.changedTouches[0]) touchId.current = event.changedTouches[0].identifier;
	...
	var createHandle = function createHandle(leftValue, bottomValue, index) {
		...
		return /* @__PURE__ */ import_react.createElement("span", handleProps);
	};
	var createRangeSlider = function createRangeSlider() {
		...
		return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, /* @__PURE__ */ import_react.createElement("span", rangeProps), rangeStartHandle, rangeEndHandle);
	};
	var createSingleSlider = function createSingleSlider() {
		...
		var rangeStyle = horizontal ? { width: handleValue + "%" } : { height: handleValue + "%" };
		var handle = horizontal ? createHandle(handleValue, null, null) : createHandle(null, handleValue, null);
		var rangeProps = mergeProps({
			className: cx("range"),
			style: _objectSpread(_objectSpread({}, sx("range")), rangeStyle)
		}, ptm("range"));
		return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, /* @__PURE__ */ import_react.createElement("span", rangeProps), handle);
	};

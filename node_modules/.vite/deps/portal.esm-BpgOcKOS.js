	...
	return _createClass$1(DomHandler, null, [
		...
		},
		{
			...
			value: function getTargetElement(target) {
				...
				else if (_typeof$3(target) === "object" && target.hasOwnProperty("current")) return this.isExist(target.current) ? target.current : null;
	...
	return _createClass$1(ObjectUtils, null, [
		{
			...
			value: function equals(obj1, obj2, field) {
				if (field && obj1 && _typeof$3(obj1) === "object" && obj2 && _typeof$3(obj2) === "object") return this.deepEquals(this.resolveFieldData(obj1, field), this.resolveFieldData(obj2, field));
		...
		},
		{
			...
			value: function getRefElement(ref) {
				if (ref) return _typeof$3(ref) === "object" && ref.hasOwnProperty("current") ? ref.current : ref;
				return null;
			}
		},
		{
		...
		},
		{
			...
			value: function mutateFieldData(data, field, value) {
				if (_typeof$3(data) !== "object" || typeof field !== "string") return;
				var fields = field.split(".");
				var obj = data;
				for (var i = 0, len = fields.length; i < len; ++i) {
					if (i + 1 - len === 0) {
	...
	return _createClass$1(IconUtils, null, [{
		...
		value: function getJSXIcon(icon) {
			...
			if (icon !== null) {
				...
				content = /* @__PURE__ */ import_react.createElement("span", _extends$1({}, iconProps, {
					className,
...
var useDebounce = function useDebounce(initialValue, delay) {
	var _React$useState2 = _slicedToArray$2(import_react.useState(initialValue), 2), inputValue = _React$useState2[0], setInputValue = _React$useState2[1];
	var _React$useState4 = _slicedToArray$2(import_react.useState(initialValue), 2), debouncedValue = _React$useState4[0], setDebouncedValue = _React$useState4[1];
...
var useDisplayOrder = function useDisplayOrder(group) {
	...
	var uid = _slicedToArray$2(import_react.useState(function() {
		return UniqueComponentId();
	}), 1)[0];
	var _React$useState4 = _slicedToArray$2(import_react.useState(0), 2), displayOrder = _React$useState4[0], setDisplayOrder = _React$useState4[1];
	import_react.useEffect(function() {
		if (isVisible) {
...
var globalEscKeyHandlingLogic = {
	...
	addListener: function addListener(callback, _ref) {
		var _this = this;
		var _ref2 = _slicedToArray$2(_ref, 2), primaryPriority = _ref2[0], secondaryPriority = _ref2[1];
...
var useOverlayListener = function useOverlayListener(_ref) {
	...
	*/
	var _useEventListener2 = _slicedToArray$2(useEventListener({
		target: "window",
		type,
	...
	var _useResizeListener2 = _slicedToArray$2(useResizeListener({
		listener: function listener(event) {
			_listener && _listener(event, {
				type: "resize",
	...
	var _useEventListener4 = _slicedToArray$2(useEventListener({
		target: "window",
...
var ComponentBase = {
	...
	extend: function extend() {
		...
		var getPTValue = function getPTValue() {
			...
			var datasetProps = !isTransition && _objectSpread$1(_objectSpread$1({}, fkey === "root" && _defineProperty$1({}, "".concat(datasetPrefix, "name"), params.props && params.props.__parentMetadata ? ObjectUtils.toFlatCase(params.props.__TYPE) : componentName)), {}, _defineProperty$1({}, "".concat(datasetPrefix, "section"), fkey));
				...
				return {
					...
					sx: function sx() {
						...
						if (arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true) {
							...
							return mergeProps([_getOptionValue(inlineStyles, key, _objectSpread$1({
								props,
								state
...
var _usePT = function _usePT(pt, callback, key, params) {
	...
	if (pt !== null && pt !== void 0 && pt.hasOwnProperty("_usept")) {
		...
		return mergeSections || !mergeSections && value ? useMergeProps ? mergeProps([originalValue, value], { classNameMergeFunction }) : _objectSpread$1(_objectSpread$1({}, originalValue), value) : value;
	}
	return fn(pt);
};
...
//#endregion
export { ObjectUtils as A, PrimeReact as C, DomHandler as D, localeOption as E, ZIndexUtils as M, classNames as N, EventBus as O, FilterService as S, ariaLabel as T, useStyle as _, useHandleStyle as a, FilterMatchMode as b, useDisplayOrder as c, useMergeProps as d, useMountEffect as f, useResizeListener as g, usePrevious as h, ComponentBase as i, UniqueComponentId as j, IconUtils as k, useEventListener as l, useOverlayScrollListener as m, Ripple as n, ESC_KEY_HANDLING_PRIORITIES as o, useOverlayListener as p, IconBase as r, useDebounce as s, Portal as t, useGlobalOnEscapeKey as u, useUnmountEffect as v, PrimeReactContext as w, FilterOperator as x, useUpdateEffect as y };
//# sourceMappingURL=portal.esm-BpgOcKOS.js.map
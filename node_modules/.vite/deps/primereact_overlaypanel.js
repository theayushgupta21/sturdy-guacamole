...
import { A as classNames, E as IconUtils, O as UniqueComponentId, S as ariaLabel, a as useDisplayOrder, b as PrimeReact, c as useMergeProps, h as useUnmountEffect, k as ZIndexUtils, l as useMountEffect, n as useHandleStyle, r as ESC_KEY_HANDLING_PRIORITIES, s as useGlobalOnEscapeKey, t as ComponentBase, u as useOverlayListener, w as DomHandler, x as PrimeReactContext } from "./componentbase.esm-BaFTkeT7.js";
import { t as Portal } from "./portal.esm-CKRPmxIf.js";
import "./iconbase.esm-k07Vs3P0.js";
import { n as OverlayService, r as TimesIcon, t as CSSTransition } from "./csstransition.esm-C2ydMrSL.js";
import { t as Ripple } from "./ripple.esm-D8dvh5fN.js";

//#region node_modules/primereact/overlaypanel/overlaypanel.esm.js
...
var OverlayPanel = /* @__PURE__ */ import_react.forwardRef(function(inProps, ref) {
	...
	var isPanelClicked = import_react.useRef(false);
	...
	var _useOverlayListener2 = _slicedToArray(useOverlayListener({
		...
		listener: function listener(event, _ref) {
			...
			if (_ref.valid) {
				if (type === "outside") {
					if (props.dismissable && !isPanelClicked.current) hide();
					isPanelClicked.current = false;
				} else if (context.hideOverlaysOnDocumentScrolling) hide();
				else if (!DomHandler.isDocument(event.target)) align();
			}
		},
		when: visibleState
	...
	var createCloseIcon = function createCloseIcon() {
		...
		var icon = props.closeIcon || /* @__PURE__ */ import_react.createElement(TimesIcon, closeIconProps);
		var closeIcon = IconUtils.getJSXIcon(icon, _objectSpread({}, closeIconProps), { props });
		...
		if (props.showCloseIcon) return /* @__PURE__ */ import_react.createElement("button", closeButtonProps, closeIcon, /* @__PURE__ */ import_react.createElement(Ripple, null));
		return null;
	};
	var element = function createElement() {
		...
		return /* @__PURE__ */ import_react.createElement(CSSTransition, _extends({ nodeRef: overlayRef }, transitionProps), /* @__PURE__ */ import_react.createElement("div", _extends({ ref: overlayRef }, rootProps), /* @__PURE__ */ import_react.createElement("div", contentProps, props.children), closeIcon));
	}();
